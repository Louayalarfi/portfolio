...
export const DEVICES = {
  ...
  headset:      { label: 'GUIDE headset',     proc: 'headset', footprint: [0.55, 0.55], pos: [ 4.55, 0.18,  1.65], rotY: -0.60, jack: { pos: [ 0.00, 0.12,  0.28], normal: [ 0, 0, 1] }, orbitR: 2.4 },
  scope:        { label: 'Oscilloscope',      proc: 'scope', footprint: [0.95, 0.50], pos: [ 0.95, 0.18,  3.02], rotY:  0.00, jack: { pos: [-0.48, 0.20,  0.00], normal: [-1, 0, 0] }, orbitR: 2.6, prop: true },
  printer:      { label: 'Pellet printer',    proc: 'printer', footprint: [1.05, 1.05], pos: [ 6.75, 0.00,  0.40], rotY: -0.90, jack: { pos: [-0.50, 0.35,  0.00], normal: [-1, 0, 0] }, orbitR: 3.4, floor: true },
